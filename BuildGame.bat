...
SET includes=/I src /I %cd%/OGRE/include/OGRE /I %cd%/OGRE/include/OGRE/Bites /I %cd%/OGRE/include/OGRE/Bullet /I %cd%/OGRE/include/OGRE/MeshLodGenerator /I %cd%/OGRE/include/OGRE/Overlay /I %cd%/OGRE/include/OGRE/Paging /I %cd%/OGRE/include/OGRE/Plugins /I %cd%/OGRE/include/OGRE/Property /I %cd%/OGRE/include/OGRE/RenderSystems /I %cd%/OGRE/include/OGRE/RTShaderSystem /I %cd%/OGRE/include/OGRE/Terrain /I %cd%/OGRE/include/OGRE/Threading /I %cd%/OGRE/include/OGRE/Volume 
SET links=/link /LIBPATH:%cd%/src /LIBPATH:%cd%/OGRE/lib MSVCRT.lib LIBCMT.lib opengl32.lib User32.lib Shell32.lib Gdi32.lib Kernel32.lib Advapi32.lib Ole32.lib Oleaut32.lib uuid.lib odbc32.lib odbccp32.lib OgreMain.lib OgreBites.lib OgreBitesQt.lib OgreBullet.lib OgreMeshLodGenerator.lib OgreOverlay.lib OgrePaging.lib OgreProperty.lib OgreRTShaderSystem.lib OgreTerrain.lib OgreVolume.lib
